    ...
    try:
        ...
        for i in range(min(10, len(reviews))):
            result.append({
                ...
                "rating":reviews[i][1],
                "content":reviews[i][2],
                "updated_at":reviews[i][3].astimezone(ZoneInfo("Asia/Taipei")).strftime("%Y-%m-%d %H:%M"),
                "reviewer":{
                    "id":reviews[i][5],
    ...
    try:
        ...
        for review in reviews:
            ...
            result.append({
                ...
                "rating": rating,
                "content": content,
                "updated_at": review_updated_at.astimezone(ZoneInfo("Asia/Taipei")).strftime("%Y-%m-%d %H:%M"),
                "product": {
                    "id": product_id,
                    "name": product_name
                }
